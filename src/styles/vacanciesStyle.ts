export const vacanciesStyle = {
  ...
  vacancyLeftBranch:
    'fixed bottom-0 left-0 max-w-[250px] max-[500px]:max-w-[150px] w-full',
  vacancyRightBranch:
    'fixed right-0 bottom-0 max-w-[250px] max-[500px]:max-w-[150px] w-full',
  burgerModificator:
    'w-[85px] h-[85px] absolute top-[15px] right-[30px] justify-end ',
  logoModificator: ' w-[85px] absolute top-[0] right-[30px] max-[992px]:hidden',
  vacancyContainer:
    'max-w-[1030px] w-full mx-auto px-[15px] pt-[110px] pb-[30px]',
  vacancyTitle: 'text-white text-h2 leading-md max-[576px]:text-md',
  vacancySubtitle:
